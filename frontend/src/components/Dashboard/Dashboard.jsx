...
import { Camera, History, Heart, TrendingUp, AlertTriangle, CheckCircle, Sparkles, ArrowRight, Plus, Activity } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-amber-700 mb-4">
                    Add your medical history and allergies to get personalized ingredient analysis and better safety recommendations.
                  </p>
                  <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Total Analyses</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.totalAnalyses}</p>
                  {stats.totalAnalyses > 0 && (
                    <p className="text-sm text-green-600 font-medium mt-1">All time</p>
                  )}
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Recent Activity</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.recentAnalyses}</p>
                  <p className="text-sm text-blue-600 font-medium mt-1">Recent items</p>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Risk Warnings</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.riskWarnings}</p>
            ...
            <div className="xl:col-span-2">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6">
                  ...
                  <p className="text-blue-100 mt-1">Get started with these common tasks</p>
                </div>
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-900 text-lg mb-2">Analyze New Image</h4>
                      <p className="text-sm text-gray-600">Upload and analyze ingredient lists with AI-powered detection</p>
                    </button>
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-900 text-lg mb-2">View History</h4>
                      <p className="text-sm text-gray-600">Browse and review all your past ingredient analyses</p>
                    </button>
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-900 text-lg mb-2">Medical Information</h4>
                      <p className="text-sm text-gray-600">Manage your allergies, conditions, and dietary restrictions for personalized analysis</p>
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6">
                  {recentAnalyses.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500 mb-4 font-medium">No analyses yet</p>
                      <button
                        onClick={() => navigate('/analyze')}
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6">
              ...
              <p className="text-green-100 mt-1">Follow these guidelines to get the most accurate results</p>
            </div>
            <div className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex items-start group">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-lg mb-2">Clear Images</p>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-lg mb-2">Complete Medical History</p>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-lg mb-2">Regular Checks</p>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-lg mb-2">Review Results</p>
                    <p className="text-gray-600">
                      Always review analysis results and consult professionals when needed
                    </p>
                  </div>
                </div>
              </div>
